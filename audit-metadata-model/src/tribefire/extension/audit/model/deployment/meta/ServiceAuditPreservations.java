...
@Description("Controls serialization of service requests and results into audit records.")
public interface ServiceAuditPreservations extends EntityTypeMetaData {
	...
	/** Kept for source and binary compatibility with the original declaration. */
